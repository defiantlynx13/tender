...
use Tender_Shop_Dir\Includes\Database\Table;
use Tender_Shop_Dir\Includes\Config\Info;
 ...
 * @package    Tender_Shop_Dir\Includes\Init
 * @author     Your_Name <youremail@nomail.com>
 * @see        \Tender_Shop_Dir\Includes\Config\Info
 * @see        \Tender_Shop_Dir\Includes\Database\Table
 */
class Activator {
...
//		if ( intval( $new_modified_tables->db_version ) > intval( get_option( 'last_your_Tender_Shop_dbs_version' ) )
//		) {
//			/*
...
//
//			update_option(
//				'last_your_Tender_Shop_dbs_version',
