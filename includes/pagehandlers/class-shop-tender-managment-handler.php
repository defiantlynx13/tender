 ...
 */
class Shop_Tender_Managment_Handler implements Page_Handler {
	...
	public function render() {
		...
		Utility::load_template( 'shop-tender-managment.shop-tender-managment', compact( 'dash_assets_url' ), 'front' );
		exit;
	}
}
