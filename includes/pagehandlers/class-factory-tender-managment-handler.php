 ...
 */
class Factory_Tender_Managment_Handler implements Page_Handler {
	...
	public function render() {
		...
		Utility::load_template( 'factory-tender-managment.factory-tender-managment', compact( 'dash_assets_url' ), 'front' );
		exit;
	}
}
