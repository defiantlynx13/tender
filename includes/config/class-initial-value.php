 ...
 *
 * @package    Tender_Shop_Name_Space
...
namespace Tender_Shop_Name_Space\Includes\Config;
...
class Initial_Value {
	...
	public static function args_for_sample_post_type() {
		$labels = [
			'name'               => _x( 'Name', 'post type general name', Tender_Shop_TEXTDOMAIN ),
			'singular_name'      => _x( 'Name', 'post type singular name', Tender_Shop_TEXTDOMAIN ),
			'menu_name'          => _x( 'Names', 'admin menu', Tender_Shop_TEXTDOMAIN ),
			'name_admin_bar'     => _x( 'Name', 'add new on admin bar', Tender_Shop_TEXTDOMAIN ),
			'add_new'            => _x( 'Add New', 'name', Tender_Shop_TEXTDOMAIN ),
			'add_new_item'       => __( 'Add New Name', Tender_Shop_TEXTDOMAIN ),
			'new_item'           => __( 'New Name', Tender_Shop_TEXTDOMAIN ),
			'edit_item'          => __( 'Edit Name', Tender_Shop_TEXTDOMAIN ),
			'view_item'          => __( 'View Name', Tender_Shop_TEXTDOMAIN ),
			'all_items'          => __( 'All Names', Tender_Shop_TEXTDOMAIN ),
			'search_items'       => __( 'Search Names', Tender_Shop_TEXTDOMAIN ),
			'parent_item_colon'  => __( 'Parent Names:', Tender_Shop_TEXTDOMAIN ),
			'not_found'          => __( 'No names found.', Tender_Shop_TEXTDOMAIN ),
			'not_found_in_trash' => __( 'No names found in Trash', Tender_Shop_TEXTDOMAIN ),
		];

		$args = [
			'labels'             => $labels,
			'description'        => __( 'Description.', Tender_Shop_TEXTDOMAIN ),
			'public'             => true,
	...
	public function sample_menu_page() {
		$initial_value = [
			'page_title'        => esc_html__( 'Msn Plugin', Tender_Shop_TEXTDOMAIN ),
			'menu_title'        => esc_html__( 'Msn Plugin', Tender_Shop_TEXTDOMAIN ),
	...
	public function sample_sub_menu_page1() {
		$initial_value = [
			...
			'page_title'        => esc_html__( 'Plugin Submenu 1', Tender_Shop_TEXTDOMAIN ),
			'menu_title'        => esc_html__( 'Plugin Submenu 1', Tender_Shop_TEXTDOMAIN ),
			'capability'        => 'manage_options',
			'menu_slug'         => 'plugin-name-option-page-url',
	...
	public function sample_sub_menu_page2() {
		$initial_value = [
			'parent-slug'       => 'plugin-name-option-page-url',
			'page_title'        => esc_html__( 'Plugin Submenu 2', Tender_Shop_TEXTDOMAIN ),
			'menu_title'        => esc_html__( 'Plugin Submenu 2', Tender_Shop_TEXTDOMAIN ),
			'capability'        => 'manage_options',
	...
	public function sample_meta_box3() {
		$initial_value = [
			...
			'id'            => 'meta_box_3_id',
			'title'         => esc_html__( 'Meta box3 Headline', Tender_Shop_TEXTDOMAIN ),
	...
	public function sample_meta_box4() {
		$initial_value = [
			...
			'id'            => 'meta_box_4_id',
			'title'         => esc_html__( 'Meta box4 Headline', Tender_Shop_TEXTDOMAIN ),
			'callback'      => 'render_content',
			'screens'       => array( 'post', 'page' ),//null - optional
	...
	public function sample_custom_post1() {
		...
		$labels = array(
			'name'               => _x( 'General Name 1', 'post type general name', Tender_Shop_TEXTDOMAIN ),
			'singular_name'      => _x( 'Name 1', 'post type singular name', Tender_Shop_TEXTDOMAIN ),
			'menu_name'          => _x( 'Names 1', 'admin menu', Tender_Shop_TEXTDOMAIN ),
			'name_admin_bar'     => _x( 'Name !', 'add new on admin bar', Tender_Shop_TEXTDOMAIN ),
			'add_new'            => _x( 'Add New ', 'Name 1', Tender_Shop_TEXTDOMAIN ),
			'add_new_item'       => __( 'Add New Name 1', Tender_Shop_TEXTDOMAIN ),
			'new_item'           => __( 'New Name 1', Tender_Shop_TEXTDOMAIN ),
			'edit_item'          => __( 'Edit Name 1', Tender_Shop_TEXTDOMAIN ),
			'view_item'          => __( 'View Name 1', Tender_Shop_TEXTDOMAIN ),
			'all_items'          => __( 'All Names 1', Tender_Shop_TEXTDOMAIN ),
			'search_items'       => __( 'Search Names 1', Tender_Shop_TEXTDOMAIN ),
			'parent_item_colon'  => __( 'Parent Names 1:', Tender_Shop_TEXTDOMAIN ),
			'not_found'          => __( 'No names 1 found', Tender_Shop_TEXTDOMAIN ),
			'not_found_in_trash' => __( 'No names 1 found in Trash', Tender_Shop_TEXTDOMAIN )
		);

		$args          = array(
			'labels'             => $labels,
			'description'        => __( 'Description 1', Tender_Shop_TEXTDOMAIN ),
			'public'             => true,
			'publicly_queryable' => true,
			'show_ui'            => true,
			'show_in_menu'       => true,
	...
	public function sample_custom_taxonomy1() {
		...
		$labels = array(
			'name'                       => _x( 'Taxonomies 1', 'taxonomy general name', Tender_Shop_TEXTDOMAIN ),
			'singular_name'              => _x( 'Taxonomy 1', 'taxonomy singular name', Tender_Shop_TEXTDOMAIN ),
			'search_items'               => __( 'Search Taxonomies 1', Tender_Shop_TEXTDOMAIN ),
			'popular_items'              => __( 'Popular Taxonomies 1', Tender_Shop_TEXTDOMAIN ),
			'all_items'                  => __( 'Taxonomies 1', Tender_Shop_TEXTDOMAIN ),
			'parent_item'                => __( 'Parent Taxonomy 1', Tender_Shop_TEXTDOMAIN ), //if not hierarchical it will be null
			'parent_item_colon'          => __( 'Parent Taxonomy 1:', Tender_Shop_TEXTDOMAIN ), //if not hierarchical it will be null
			'edit_item'                  => __( 'Edit Taxonomy 1', Tender_Shop_TEXTDOMAIN ),
			'update_item'                => __( 'Update Taxonomy 1', Tender_Shop_TEXTDOMAIN ),
			'add_new_item'               => __( 'Add New Taxonomy 1', Tender_Shop_TEXTDOMAIN ),
			'new_item_name'              => __( 'New  Taxonomy 1 Name', Tender_Shop_TEXTDOMAIN ),
			'separate_items_with_commas' => __( 'Separate Taxonomy 1 with commas', Tender_Shop_TEXTDOMAIN ),
			'add_or_remove_items'        => __( 'Add or remove  Taxonomies 1', Tender_Shop_TEXTDOMAIN ),
			'choose_from_most_used'      => __( 'Choose from the most used Taxonomies 1', Tender_Shop_TEXTDOMAIN ),
			'not_found'                  => __( 'No Taxonomies 1 found.', Tender_Shop_TEXTDOMAIN ),
			'menu_name'                  => __( 'Taxonomies 1', Tender_Shop_TEXTDOMAIN ),
		);
