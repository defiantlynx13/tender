        ...
        <div class="content-body"><!-- stats -->
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> مناقصات جاری کارخانه ها</h4>
                ...
                <div class="col-xs-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">مناقصات ارشیو شده کارخانه ها</h4>
                            <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="fa fa-minus"></i></a></li>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="new_tender_only_one" id="new_tender_only_one" value="yes"> این مناقصه حتی با شرکت یک کارخانه برگزار خواهد شد.
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="edit_tender_only_one" id="edit_tender_only_one" value="yes"> این مناقصه حتی با شرکت یک کارخانه برگزار خواهد شد.
                                        </label>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog  modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="factory_tender_contributers_title"></h4>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-hover mb-0" id="tender_contributors_tbl">
                        <thead>
                            <tr>
                                ...
                                <th>مدیریت</th>
                                <th>شماره تماس</th>
                                <th class="hidden-print">فایل  پیشنهادی کارخانه</th>
                            </tr>
                        </thead>
