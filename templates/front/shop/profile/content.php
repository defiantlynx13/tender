                                        ...
                                        <form class="form" name="update_shop_data" id="update_shop_data">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            <label for="shop_name">نام فروشگاه/کارخانه</label>
                                            ...
                                            <div class="form-actions right">
                                                <button type="button" class="btn btn-outline-green tnd_round" name="update_shop_data_btn" id="update_shop_data_btn">
                                                    <i class="fa fa-check"></i> درخواست بررسی اطلاعات فروشگاه/کارخانه
                                                </button>
                                            </div>
                                        </form>
                                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                پس از ارسال اطلاعات فروشگاه/کارخانه، کارشناسان ما اقدام به بررسی اطلاعات ارسالی شما می نمایند.
