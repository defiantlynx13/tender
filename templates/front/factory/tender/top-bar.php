    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                <li class="nav-item mobile-menu hidden-md-up float-xs-left"><a class="nav-link nav-menu-main menu-toggle hidden-xs"><i class="fa fa-bars icon-menu5 font-large-1"></i></a></li>
        ...
        <div class="navbar-container content container-fluid">
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                <ul class="nav navbar-nav">
                    <li class="nav-item hidden-sm-down"><a class="nav-link nav-menu-main menu-toggle hidden-xs is-active"><i class="fa fa-bars">         </i></a></li>
                </ul>
                <ul class="nav navbar-nav float-xs-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="<?php echo home_url('profile');?>" class="dropdown-item"><i class="fa fa-id-card"></i>  پروفایل</a>
...
<!--                            <a href="#" class="dropdown-item"><i class="icon-mail6"></i> صندوق ورودی من</a>-->
                            ...
                            <a href="<?php echo wp_logout_url( home_url('login') ); ?>" class="dropdown-item"><i class="fa fa-power-off"></i> خروج</a>
                        </div>
                    </li>
                </ul>
            </div>
