jQuery(document).ready(function($){
    ...
    function fetch_data_current_tenders()
    {
        $('#current_tenders_tbl').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url"  : myData.ajax_url+'?action=get_all_current_shop_tenders_data&user_id='+myData.user_id
            },
    ...
    $(document).on('click','#request_tender_btn',function () {
        ...
        $('#tender_tools_advisor').FancyFileUpload({
            ...
            params :
                {
                    action :'tnd_shop_tender_request_tool_file' ,
    ...
    function fetch_data_requested_tenders()
    {
        $('#requested_tenders_tbl').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url"  : myData.ajax_url+'?action=get_all_requested_shop_tenders_data&user_id='+myData.user_id
            },
            "fnDrawCallback" : function() {
                traverse(document.body);
            }
    ...
    function fetch_data_winned_tenders()
    {
        $('#winned_tenders_tbl').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url"  : myData.ajax_url+'?action=get_all_winned_shop_tenders_data&user_id='+myData.user_id
            },
            "fnDrawCallback" : function() {
                traverse(document.body);
            }
