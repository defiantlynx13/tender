jQuery(document).ready(function($){
    ...
    function fetch_data()
    {
        $('#tender_managment_tbl').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url"  : myData.ajax_url+'?action=get_all_factory_tenders_data&user_id='+myData.user_id
            },
    ...
    function fetch_archived_tenders_data()
    {
        $('#archived_tenders_tbl').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url"  : myData.ajax_url+'?action=get_all_factory_archived_tenders_data&user_id='+myData.user_id
            },
            rowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                if ( aData[8] == "true" )
                {
    ...
    $('body').on('click','#add_row_tender',function () {
        $.post(
            myData.ajax_url,
            {
                action : 'get_contractors_executed_tenders_for_factory',
    ...
    $('#new_tender_files').FancyFileUpload({
        ...
        params :
            {
                action :'new_factory_tender_upload_files' ,
                user_id : myData.user_id ,
            },
        ...
        uploadcompleted :function(e, data)
        {
            $.post(
                myData.ajax_url,
                {
                    action : 'add_info_to_new_factory_tender',
    ...
    $(document).on('click','#tender_edit_btn',function (event) {
        ...
        $.post(
            myData.ajax_url,
            {
                action : 'edit_get_contractors_executed_tenders_for_factory',
                user_id:  myData.user_id,
                tender_id:  tender_id,
            },
            function (response)
    ...
    $(document).on('click','#tender_contributors_btn',function () {
        ...
        $.post(
            myData.ajax_url,
            {
                action : 'get_factory_tender_contributors',
                user_id:  myData.user_id,
            ...
            function (response)
            {
                if (response.success=='true')
                {
                    ...
                    $('#factory_tender_contributers_title').html('');
                    $('#factory_tender_contributers_title').append(response.tender_title);
    ...
    $(document).on('click','#run_tender_btn',function () {
        ...
        $.post(
            myData.ajax_url,
            {
                action : 'get_factory_tender_contributors_and_files',
                user_id:  myData.user_id,
                tender_id:  $(this).data('tender_id'),
            },
            function (response)
    ...
    $(document).on('click','#delete_factory_tender_btn',function () {
