        ...
        $.post(
            ...
            function (response)
            {
                if (response.status == 'true')
                {
                    $.notify(
                        {
                            message: 'اطلاعات کارخانه شما برای کارشناس مربوطه ارسال گردید! پس از تایید مدارک ، می توانید در مناقصات شرکت نمایید!'
                        },
                        {
                            type: 'success',
                            placement: {
                ...
                else if(response.status == 'false')
                {
                    ...
                    $.notify(
                        {
                            message: 'یکی از اطلاعات کارخانه وارد نشده است.'
                        },
                        {
                            type: 'danger',
                            placement: {
